...
var HTMLcontactGeneric = '<li class="flex-item"><span class="orange-text">%contact%</span><span class="contact-data">%data%</span></li>';
...
var HTMLskills = '<li class="flex-item skill"><span class="skill-text">%data%</span></li>';
